# api/routes/audio.py - Whisper Audio Processing
"""
Endpoints для обработки аудио через Whisper API.
"""
import os
import tempfile
...
from api.dependencies import get_whisper_service, get_chat_service, get_cache_manager, get_rate_limiter
